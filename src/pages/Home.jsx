          ...
          {freshLoading ? (
            ...
            <div className="flex gap-6 overflow-x-auto pb-10 scrollbar-hide snap-x snap-mandatory">
              {freshPackages.map((pack) => (
                <div
                  key={pack._id}
                  className="min-w-[260px] snap-center group relative bg-white rounded-[2.5rem] p-5 flex flex-col justify-between shadow-sm hover:shadow-xl transition-all border border-slate-100"
                >
                  {/* Top row: image + favorite */}
                  <div className="relative bg-gradient-to-br from-[#F9F5FF] to-[#EEF2FF] rounded-[20px] h-40 flex items-center justify-center mb-3 overflow-hidden">
                    ...
                    <img
                      src={pack.image || "https://via.placeholder.com/200"}
                      alt={pack.name}
                      className="max-h-28 object-contain drop-shadow-xl"
                    />
                  </div>
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="mt-3 flex items-center justify-between gap-2">
                      <button
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1 px-4 py-2 rounded-full bg-green-700 text-white text-xs font-semibold hover:bg-green-800 disabled:opacity-60"
                      >
                        {addingId === pack._id ? (
